package com.revsup.reactwheel.com.revsup.reactwheel.objects;
...
public class Wheel extends ShapeRenderer {
    ...
    //colors
    private static final Color BACKGROUND = new Color(255/255f, 255/255f, 255/255f, 1f);
    private static final Color RED = new Color(231/255f, 76/255f, 60/255f, 1f);
    private static final Color YELLOW = new Color(255/255f, 185/255f, 0/255f, 1f);
  ...
  //  float stateTime;
    ...
    public void render(){
        ...
        this.circle(center.x, center.y, radius/1.42f, 100);

        //center circle
        setColor(WHITE);
        circle(center.x, center.y, radius/1.14f, 100);
       ...
       // center circle8
        setColor(WHITE);
        circle(center.x, center.y, radius/15f, 100);

        //center circle7
        setColor(RED);
        circle(center.x, center.y, radius/1.53f, 100);
        //center circle6
        setColor(WHITE);
        circle(center.x, center.y, radius/1.59f, 100);
        ...
        //CENTER CIRCLE4
       setColor(WHITE);
        this.circle(center.x,center.y, radius/2.2f,100);

        //CENTER circle 3
        setColor(RED);
        this.circle(center.x,center.y, radius/3.2f,100);

        //center circle2
        setColor(WHITE);
        circle(center.x, center.y, radius/3.39f, 100);

        //center circle
        setColor(YELLOW);
        circle(center.x, center.y, radius/3.49f, 100);
